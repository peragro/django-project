...
config = {
    ...
    'install_requires': ['django-autoslug', 'django-reversion', 'south', 'pytz', 'django-notifications-hq', 'django-follow', 'django-filter', 'drf-nested-routers', 'django-cors-headers'],
    'test_requires': [],
