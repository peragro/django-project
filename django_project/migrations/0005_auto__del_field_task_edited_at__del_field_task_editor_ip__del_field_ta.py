...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Task.edited_at'
        db.delete_column(u'django_project_task', 'edited_at')

        # Deleting field 'Task.editor_ip'
        db.delete_column(u'django_project_task', 'editor_ip')

        # Deleting field 'Task.author_ip'
        db.delete_column(u'django_project_task', 'author_ip')

        # Deleting field 'Task.editor'
        db.delete_column(u'django_project_task', 'editor_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Task.edited_at'
        raise RuntimeError("Cannot reverse this migration. 'Task.edited_at' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Task.edited_at'
        db.add_column(u'django_project_task', 'edited_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Task.editor_ip'
        db.add_column(u'django_project_task', 'editor_ip',
                      self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Task.author_ip'
        db.add_column(u'django_project_task', 'author_ip',
                      self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Task.editor'
        db.add_column(u'django_project_task', 'editor',
    ...
    models = {
        ...
        u'django_project.milestone': {
            ...
            'deadline': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 16, 0, 0)'}),
