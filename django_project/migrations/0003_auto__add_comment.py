...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'django_project_comment', (
        ...
        db.send_create_signal(u'django_project', ['Comment'])


    def backwards(self, orm):
        # Deleting model 'Comment'
        db.delete_table(u'django_project_comment')
    ...
    models = {
        ...
        u'django_project.comment': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'comment_comments'", 'to': u"orm['auth.User']"})
        },
