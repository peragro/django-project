...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.editor_ip'
        db.alter_column(u'django_project_task', 'editor_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True))

        # Changing field 'Task.author_ip'
        db.alter_column(u'django_project_task', 'author_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Task.editor_ip'
        raise RuntimeError("Cannot reverse this migration. 'Task.editor_ip' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Task.editor_ip'
        db.alter_column(u'django_project_task', 'editor_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15))

        # User chose to not deal with backwards NULL issues for 'Task.author_ip'
        raise RuntimeError("Cannot reverse this migration. 'Task.author_ip' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Task.author_ip'
        db.alter_column(u'django_project_task', 'author_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15))
