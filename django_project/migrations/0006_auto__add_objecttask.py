...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ObjectTask'
        db.create_table(u'django_project_objecttask', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name='objecttask_tasks', to=orm['django_project.Task'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='content_type_set_for_objecttask', to=orm['contenttypes.ContentType'])),
            ('object_pk', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'django_project', ['ObjectTask'])


    def backwards(self, orm):
        # Deleting model 'ObjectTask'
        db.delete_table(u'django_project_objecttask')
    ...
    models = {
        ...
        u'django_project.milestone': {
            ...
            'deadline': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 25, 0, 0)'}),
